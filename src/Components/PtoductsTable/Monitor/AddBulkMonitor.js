...
export default function AddBulkMonitor(props) {
    ...
    const handleUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://pc-builder-backend-git-main-togadiya123.vercel.app/item/addmonitorfile",
                formData,
                {
                    headers: {
    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth='md' fullWidth>
                <DialogTitle sx={{ backgroundColor: "aliceblue" }} >Add Bulk Monitor</DialogTitle>
