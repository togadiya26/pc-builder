...
import style from './Storage2Table.module.css';
...
import AddStorage2 from './AddStorage2';
import UpdateStorage2 from './UpdateStorage2';
import ColorRingLoader from '../../Loader/ColorRingLoader';
import AddBulkStorage2 from './AddBulkStorage2';
...
export default function Storage2Table(props) {
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - Storage2.length) : 0;
  ...
  return (
    <React.Fragment>
      <div className={style.tableHead}>
        ...
        <AddBulkStorage2 sSP={setStorage2} load={load} />
        <AddStorage2 sP={Storage2} sSP={setStorage2} load={load} />
      </div>
      <div>
        <TableContainer component={Paper} sx={{ marginTop: "2%", backgroundColor: "aliceblue" }}>
          <Table sx={{ width: "100%" }} aria-label="custom pagination table">
            ...
            {load ?
              ...
              <TableBody>
                {
                  (rowsPerPage > 0 && Storage2.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).filter((ele) => ele.productname.toLowerCase().toString().match(search.toLowerCase().toString()) ||
