...
export default function AddBulkStorage2(props) {
    ...
    const handleUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://pc-builder-backend-git-main-togadiya123.vercel.app/item/addstorage2file",
                formData,
                {
                    headers: {
    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth='md' fullWidth>
                <DialogTitle sx={{ backgroundColor: "aliceblue" }} >Add Bulk Storage 2</DialogTitle>
