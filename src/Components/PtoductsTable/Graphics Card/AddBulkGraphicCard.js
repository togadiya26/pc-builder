...
export default function AddBulkGraphicsCard(props) {
    ...
    const handleUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://pc-builder-backend-git-main-togadiya123.vercel.app/item/addgraphicscardfile",
                formData,
                {
                    headers: {
    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth='md' fullWidth>
                <DialogTitle sx={{ backgroundColor: "aliceblue" }} >Add Bulk Graphics Card</DialogTitle>
