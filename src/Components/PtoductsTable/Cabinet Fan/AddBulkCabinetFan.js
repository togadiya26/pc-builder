...
export default function AddBulkCabinetFan(props) {
    ...
    const handleUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://pc-builder-backend-git-main-togadiya123.vercel.app/item/addcabinetfanfile",
                formData,
                {
                    headers: {
    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} maxWidth='md' fullWidth>
                <DialogTitle sx={{ backgroundColor: "aliceblue" }} >Add Bulk Cabinet Fan</DialogTitle>
